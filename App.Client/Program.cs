...
builder.Services.AddScoped<App.Shared.Services.Tools.CloudToolModule>();
...
builder.Services.AddScoped<IToolModule>(sp => sp.GetRequiredService<App.Shared.Services.Tools.CloudToolModule>());
