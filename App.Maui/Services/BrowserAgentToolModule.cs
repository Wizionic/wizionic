...
public sealed class BrowserAgentToolModule : IToolModule
{
    ...
    [Description("REQUIRED for navigation: open a URL in the Wizionic embedded browser panel. Pass a full http(s) URL (add https:// if the user only gave a domain like google.com).")]
