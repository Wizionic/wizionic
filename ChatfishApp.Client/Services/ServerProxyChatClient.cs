...
internal sealed class ServerProxyChatClient : IChatClient
{
    ...
    public ServerProxyChatClient(string providerId, string modelId)
    {
    ...
    private static HttpClient Http =>
        WasmAiProviderService.ProxyHttp
        ?? throw new InvalidOperationException("WasmAiProviderService.ProxyHttp is not configured.");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        using var response = await Http.PostAsJsonAsync("/api/proxy/chat", request, cancellationToken);
