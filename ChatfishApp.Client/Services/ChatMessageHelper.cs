...
/// <summary>
/// Helpers for per-item identity, soft-delete tombstones, and sync conflict timestamps.
/// </summary>
public static class ChatMessageHelper
{
    ...
    /// <summary>
    /// Latest activity across visible items and their tombstones (for delete vs edit conflicts).
    /// </summary>
