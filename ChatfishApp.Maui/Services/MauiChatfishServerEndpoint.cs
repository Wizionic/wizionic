...
public sealed class MauiChatfishServerEndpoint : IChatfishServerEndpoint
{
    ...
    internal static string ResolveDefaultFeedUrl(string baseUrl)
    {
        ...
        return baseUrl.TrimEnd('/') + "/" + ChatfishServerOptions.DefaultUpdateFeedPath;
    }

    /// <summary>Public chatfish.me feed for the current OS (never cross-platform).</summary>
    internal static string PublicProductionFeedUrl() =>
        IsLinuxDesktop()
            ? "https://chatfish.me/releases/linux"
